...
class ParserTest < Minitest::Test
  ...
  def test_it_can_parser_json
    ...
    assert_equal "63.29.38.211",  Parser.new.parse(payload, "woo")[:ip]
    assert_equal "http://jumpstartlab.com/blog",  Parser.new.parse(payload, "woo")[:url]
    assert_equal 37,  Parser.new.parse(payload, "woo")[:responded_in]
  end
