...
class UrlTest < Minitest::Test
  ...
  def test_it_has_a_url
    urls = Url.create(address:"http://jumpstartlab.com/blog")

    assert_equal "http://jumpstartlab.com/blog", urls.address
  end

  def test_validates_address
    address = Url.create(address:"http://jumpstartlab.com/blog")
  ...
  def test_addresses_must_be_unique
    ...
    other_address = Url.create(address:"http://jumpstartlab.com/blog")
